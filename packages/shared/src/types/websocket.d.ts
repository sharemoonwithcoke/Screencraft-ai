...
export type ServerToClientEvent = AISpeechRateEvent | AITeleprompterMissEvent | AIZoomTriggerEvent | AIZoomResetEvent | AINoiseDetectedEvent | AIFillerWordEvent | AIPauseEvent | AIMonotoneEvent | AIChapterMarkerEvent | AIClickRippleEvent | AIBlurEvent;
