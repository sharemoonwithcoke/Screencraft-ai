...
export type ServerToClientEvent = AISpeechRateEvent | AITeleprompterMissEvent | AINoiseDetectedEvent | AIFillerWordEvent | AIPauseEvent | AIMonotoneEvent | AIChapterMarkerEvent | AIClickRippleEvent | AIBlurEvent;
